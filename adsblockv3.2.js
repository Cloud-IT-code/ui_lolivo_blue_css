...
function adBlockClose() {
    document.getElementById("WgD").classList.remove("is-detected"), document.getElementById("idpo").classList.remove("idecla"), document.body.classList.remove("ab-is-detected")
}
